function [] = rsa_impexpII_searchlight_torque(sample)
% This is a copy of my searchlight script to be used as a function so that
% it can be called by the torque wrapper, tremendously speeding up the process.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                           %
%      TORQUE VERSION       %   
...
%% Global ini
%clear all; clc
cd('/home/predatt/chrutz/ImpexpII/PipelineLionTurtleAugust')
...
warp           = 1;       % Warp output images for further processing
...
example_mask = [fMRI_dir filesep 'Anatomical' filesep 'rwhole_brain_mask.nii'];
