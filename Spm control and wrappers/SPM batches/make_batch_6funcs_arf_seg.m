function [matlabbatch] = make_batch_6funcs_arf_seg(config)
...
% Slice Timing Correction
matlabbatch{9}.spm.temporal.st.scans{1}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 1)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{1}, '.','rfiles'));
matlabbatch{9}.spm.temporal.st.scans{2}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 2)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{2}, '.','rfiles'));
matlabbatch{9}.spm.temporal.st.scans{3}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 3)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{3}, '.','rfiles'));
matlabbatch{9}.spm.temporal.st.scans{4}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 4)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{4}, '.','rfiles'));
matlabbatch{9}.spm.temporal.st.scans{5}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 5)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{5}, '.','rfiles'));
matlabbatch{9}.spm.temporal.st.scans{6}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 6)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{6}, '.','rfiles'));
matlabbatch{9}.spm.temporal.st.nslices = n_slices;
matlabbatch{9}.spm.temporal.st.tr = TR;
matlabbatch{9}.spm.temporal.st.ta = TA;
matlabbatch{9}.spm.temporal.st.so = slice_order;
matlabbatch{9}.spm.temporal.st.refslice = reference_slice;
matlabbatch{9}.spm.temporal.st.prefix = 'a';

% Coregistration
matlabbatch{10}.spm.spatial.coreg.estimate.ref(1) = cfg_dep('Realign: Estimate & Reslice: Mean Image', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','rmean'));
matlabbatch{10}.spm.spatial.coreg.estimate.source(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^s.*\.nii)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
% Segmentation
matlabbatch{11}.spm.spatial.preproc.channel.vols(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^s.*\.nii)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{11}.spm.spatial.preproc.channel.biasreg = 0.001;
matlabbatch{11}.spm.spatial.preproc.channel.biasfwhm = 60;
matlabbatch{11}.spm.spatial.preproc.channel.write = [0 0];
matlabbatch{11}.spm.spatial.preproc.tissue(1).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,1'};
...
matlabbatch{11}.spm.spatial.preproc.tissue(2).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,2'};
...
matlabbatch{11}.spm.spatial.preproc.tissue(3).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,3'};
...
matlabbatch{11}.spm.spatial.preproc.tissue(4).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,4'};
...
matlabbatch{11}.spm.spatial.preproc.tissue(5).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,5'};
...
matlabbatch{11}.spm.spatial.preproc.tissue(6).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,6'};
