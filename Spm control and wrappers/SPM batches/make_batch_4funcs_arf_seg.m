function[matlabbatch] = make_batch_4funcs_arf_seg(config)
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {func_folders{1}};
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.filter = prefix;
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {func_folders{2}};
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter =  prefix;
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {func_folders{3}};
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.filter =  prefix;
matlabbatch{3}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {func_folders{4}};
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_fplist.filter =  prefix;
matlabbatch{4}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.dir = {T1_dir};
matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.filter = '^s.*\.nii';
matlabbatch{5}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';

% Realign
matlabbatch{6}.spm.spatial.realign.estwrite.data{1}(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^f.*\.nii)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{6}.spm.spatial.realign.estwrite.data{2}(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^f.*\.nii)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{6}.spm.spatial.realign.estwrite.data{3}(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^f.*\.nii)', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{6}.spm.spatial.realign.estwrite.data{4}(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^f.*\.nii)', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{6}.spm.spatial.realign.estwrite.eoptions.interp = 4;
...
matlabbatch{7}.spm.temporal.st.scans{1}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 1)', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{1}, '.','rfiles'));
matlabbatch{7}.spm.temporal.st.scans{2}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 2)', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{2}, '.','rfiles'));
matlabbatch{7}.spm.temporal.st.scans{3}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 3)', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{3}, '.','rfiles'));
matlabbatch{7}.spm.temporal.st.scans{4}(1) = cfg_dep('Realign: Estimate & Reslice: Resliced Images (Sess 4)', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sess', '()',{4}, '.','rfiles'));
matlabbatch{7}.spm.temporal.st.nslices = n_slices;
matlabbatch{7}.spm.temporal.st.tr = TR;
matlabbatch{7}.spm.temporal.st.ta = TA;
matlabbatch{7}.spm.temporal.st.so = slice_order;
matlabbatch{7}.spm.temporal.st.refslice = reference_slice;
matlabbatch{7}.spm.temporal.st.prefix = 'a';

% Coregistration
matlabbatch{8}.spm.spatial.coreg.estimate.ref(1) = cfg_dep('Realign: Estimate & Reslice: Mean Image', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','rmean'));
matlabbatch{8}.spm.spatial.coreg.estimate.source(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^s.*\.nii)', substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
% Segmentation
matlabbatch{9}.spm.spatial.preproc.channel.vols(1) = cfg_dep('File Selector (Batch Mode): Selected Files (^s.*\.nii)', substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{9}.spm.spatial.preproc.tissue(1).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,1'};
...
matlabbatch{9}.spm.spatial.preproc.tissue(2).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,2'};
...
matlabbatch{9}.spm.spatial.preproc.tissue(3).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,3'};
...
matlabbatch{9}.spm.spatial.preproc.tissue(4).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,4'};
...
matlabbatch{9}.spm.spatial.preproc.tissue(5).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,5'};
...
matlabbatch{9}.spm.spatial.preproc.tissue(6).tpm = {'/home/common/matlab/spm12b/tpm/TPM.nii,6'};
...
matlabbatch{9}.spm.spatial.preproc.warp.write = [1 1];


disp('Created a batch for SPM preprocessing')
